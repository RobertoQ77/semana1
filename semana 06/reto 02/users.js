class User {
    ...
    gameover() {
        ...
        this.playtime = ((Number(this.gameover_at.getSeconds()) - Number(this.created_at.getSeconds())) + 60 * (Number(this.gameover_at.getMinutes()) - Number(this.created_at.getMinutes()))).toString() + " S";
    }
}
